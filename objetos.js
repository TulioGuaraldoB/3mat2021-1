...
console.log(pessoa['dataNasc']) // Sintaxe do colchete

// A sintaxe dos colchetes é importante também quando o nome da propriedade 
// está armazenada em variável
let prop = 'nome'
...
// Variáveis: 
// prop -> a variável que irá conter o nome do de cada uma das propriedades 
...
// O objeto veiculo antes da exclusão da propriedade
console.table(veiculo)
