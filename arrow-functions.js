...
// que é um modo "abreviado" de escrever função em JS

// 1) Os parênteses em torno do parâmetro foram omitidos
// 2) A palavra *function*, que vinha ANTES do parâmetro, foi substítuida
...
// chama-lá posteriormente, é necessário, atribui-lá a uma variável.
...
function megasena() {
    ...
    // Math.ceil() -> retira as casas decimas de um número, deixando apenas
    // a parte inteira
    return Math.ceil(Math.random() * 60 + 1)
}
console.log(megasena(), megasena(), megasena(), megasena(), megasena(), megasena())

// Os parênteses vázios (obrigatórios) marcam o lugar dos parâmetros
